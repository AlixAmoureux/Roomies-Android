...
import roomies.com.roomies.controllers.mainactivity.managecoloc.joincoloc.colocinfos.MembersAdapter;
import roomies.com.roomies.models.users.MembersInfo;

public class RoomiesMembersFragment extends Fragment {

    private static final String TAG = "RoomiesMembersFragment";
    ...
    public void onResume() {
        ...
        getActivity().setTitle("Roomies members");
